    ...
    return (
      <div className="ProjectPage">
        ...
        <div className="Content">
          ...
          <hr />
          <p>
            <a href="/projects/planning_poker/privacy_policy">Privacy Policy</a>
          </p>
          <p>
            <a href="/projects/planning_poker/terms_and_conditions">
              Terms & Conditions
            </a>
          </p>
        </div>
...
export const planning_poker_terms_and_conditions: IStandardPageProps = {
  title: "Planning Poker Online: Terms & Conditions",
  content: (
    <div>
      <p>
      ...
      <p>
        Alessio Bianchetti is committed to ensuring that the app is as useful
      ...
      <p>
        The Planning Poker (SCRUM) app stores and processes personal data that
        ...
        phone’s security features and it could mean that the Planning Poker
        (SCRUM) app won’t work properly or at all.
      </p>

      <p>
        You should be aware that there are certain things that Alessio
        Bianchetti will not take responsibility for. Certain functions of the
        ...
        but Alessio Bianchetti cannot take responsibility for the app not
      ...
      <p>
        Along the same lines, Alessio Bianchetti cannot always take
        ...
        turn it on to avail the Service, Alessio Bianchetti cannot accept
        responsibility.
      </p>

      <p>
        With respect to Alessio Bianchetti’s responsibility for your use of the
        ...
        we can make it available to you. Alessio Bianchetti accepts no liability
      ...
      <p>
        ...
        keep using the app. Alessio Bianchetti does not promise that it will
      ...
      <p>
        ...
        do not hesitate to contact me at alessio.bianchetti@gmail.com.
      </p>
    </div>
  )
};
